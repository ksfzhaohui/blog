...
public abstract class MethodAccessTest {
    ...
    static public MethodAccessTest get (Class type) throws IOException {
        ...
        Class accessClass;
        AccessClassLoaderTest loader = AccessClassLoaderTest.get(type);
        synchronized (loader) {
            ...
            if (accessClass == null) {
                ...
                FileOutputStream fileOutputStream = new FileOutputStream(new File("F:/asm/methodAccesstest.class"));
        ...
        try {
            MethodAccessTest access = (MethodAccessTest)accessClass.newInstance();
