...
public abstract class FieldAccessTest {
    ...
    static public FieldAccessTest get (Class type) throws IOException {
        ...
        synchronized (loader) {
            ...
            if (accessClass == null) {
                ...
                cw.visitEnd();
                FileOutputStream fileOutputStream = new FileOutputStream(new File("F:/asm/fieldAccesstest.class"));
        ...
        try {
            FieldAccessTest access = (FieldAccessTest)accessClass.newInstance();
